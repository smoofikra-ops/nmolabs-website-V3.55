...
export const Blog = () => {
  ...
  if (isMobile) {
    return (
      <section className="py-20 relative overflow-hidden bg-black/10" id="blog">
        {/* Background decoration */}
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-72 h-72 bg-[color:var(--color-brand-blue-val)] opacity-10 blur-[100px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-6 mb-10 relative z-10 text-center">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-2xl font-bold mb-4 text-[color:var(--color-text-main)]"
          >
            مدونة مختبرات النمو
          </motion.h2>
